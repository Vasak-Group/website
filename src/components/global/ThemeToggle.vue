<template>
    ...
    C499.712,162.12,461.392,89.64,401.92,42.776z"></path>
        ...
        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
            y="0px" viewBox="0 0 512 512" class="icon icon-tabler icon-tabler-toggle-right" xml:space="preserve">
            <g>
                <circle style="fill:#FFD347;" cx="255.997" cy="255.997" r="144.824"></circle>
                <path style="fill:#FFD347;" d="M256,56.849c-4.273,0-7.737-3.463-7.737-7.737V7.737C248.263,3.463,251.727,0,256,0
    s7.737,3.463,7.737,7.737v41.376C263.737,53.386,260.273,56.849,256,56.849z"></path>
    ...
    C155.206,84.234,153.876,84.568,152.563,84.568z"></path>
    ...
    C82.097,158.907,79.497,160.294,76.823,160.294z"></path>
                <path style="fill:#FFD347;" d="M49.112,263.737H7.737C3.464,263.737,0,260.274,0,256s3.464-7.737,7.737-7.737h41.376
    c4.273,0,7.737,3.463,7.737,7.737S53.385,263.737,49.112,263.737z"></path>
    ...
    C43.648,387.535,42.317,387.869,41.005,387.869z"></path>
    ...
    C137.136,477.352,134.536,478.74,131.862,478.74z"></path>
                <path style="fill:#FFD347;" d="M256,512c-4.273,0-7.737-3.463-7.737-7.737v-41.376c0-4.274,3.464-7.737,7.737-7.737
    s7.737,3.463,7.737,7.737v41.376C263.737,508.537,260.273,512,256,512z"></path>
  ...
  S335.983,111.18,256,111.18z"></path>
        </svg>
    </div>
</template>
