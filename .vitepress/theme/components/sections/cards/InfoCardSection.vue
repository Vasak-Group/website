...
const isEven = computed(() => ((props.index ?? 0) % 2) === 0)
</script>

<template>
    <section
        :class="['w-full py-24 flex justify-center items-center', isEven ? 'flex-row' : 'flex-row-reverse bg-slate-200 dark:bg-slate-900']">
